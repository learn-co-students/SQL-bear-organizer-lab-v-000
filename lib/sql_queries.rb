...
def selects_all_female_bears_return_name_and_age
  'SELECT name, age FROM bears WHERE Gender = "F";'  # Had to use '==' at the beginning. Now it's OK.
end
...
def selects_bear_that_killed_Tim
  'SELECT * FROM bears WHERE name IS NULL;'  #NULL: Doesn't need ''; Must use 'IS', NOT '='
end
